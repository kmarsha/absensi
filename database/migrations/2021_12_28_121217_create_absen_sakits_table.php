...
class CreateAbsenSakitsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('absen_sakits', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('nis_id');
            $table->unsignedBigInteger('absen_id');
            $table->tinyText('alasan_s');
    ...
    {
        Schema::dropIfExists('absen_sakits');
    }
}
